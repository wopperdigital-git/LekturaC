...
- Quizzes, questions, postings and attempts are now written by the quiz feature (`docs/superpowers/specs/2026-09-24-quiz-generator-design.md`, migration 0012); read it before touching quiz storage, posting or scoring.
